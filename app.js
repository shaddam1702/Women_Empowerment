...
var  indexfirRoute     =  require("./routes/indexfir");
var  indexjobRoute     =  require("./routes/indexjob");
var sendemail = require('./routes/send-email');
var sendotp = require('./routes/send-otp');
...
app.use(indexfirRoute); 
app.use(indexjobRoute); 
